...
# results file name
RESULTS_FILE="${RESULTS_FILE:-"prc-e2e"}"
...
echo "Running podman-remote-client e2e tests"
# e2e envs
if [[ ${PLATFORM} == 'windows' ]]; then
...
echo "Getting podman-remote-client e2e test results and logs"
# Get results
